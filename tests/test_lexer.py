    ...
    (
        ...
        (
            ...
            [
                ...
                Token(TokenType.NUMBER, "1", 1, index=2),
                EOF,
            ],
        ),
        (
    ...
    (
        (
            ...
            [
                ...
                Token(TokenType.NUMBER, "5", 5.0, index=23),
        ...
        (
            ...
            [
                ...
                Token(TokenType.NUMBER, "0", 0.0, index=8),
                ...
                Token(TokenType.NUMBER, "1", 1.0, index=19),
                ...
                Token(TokenType.NUMBER, "10000", 10000.0, index=34),
